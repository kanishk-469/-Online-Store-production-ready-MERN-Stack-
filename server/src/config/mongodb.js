...
// get database client to set-up transaction in our order.repository.js file
...
export const createCounter = async (db) => {
  ...
  if (!existingCounter) {
    // Whenever i am passing value to _id as "cartItemId" so mongodb wouldn't create new one
...
const createIndexes = async (db) => {
  try {
    ...
    //Text based index ,  when we have large paragraph
